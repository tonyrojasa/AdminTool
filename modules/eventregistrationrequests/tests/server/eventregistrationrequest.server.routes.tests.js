...
describe('Eventregistration CRUD tests', function () {
  ...
  it('should be able to save a Eventregistration if logged in', function (done) {
    agent.post('/api/auth/signin')
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/eventregistrationrequests')
          ...
          .end(function (eventregistrationSaveErr, eventregistrationSaveRes) {
            ...
            // Get a list of Eventregistrationrequests
            agent.get('/api/eventregistrationrequests')
              .end(function (eventregistrationsGetErr, eventregistrationsGetRes) {
                ...
                var eventregistrationrequests = eventregistrationsGetRes.body;

                // Set assertions
                (eventregistrationrequests[0].user._id).should.equal(userId);
                (eventregistrationrequests[0].name).should.match('Eventregistration name');
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/eventregistrationrequests')
          ...
          .end(function (eventregistrationSaveErr, eventregistrationSaveRes) {
            ...
            agent.put('/api/eventregistrationrequests/' + eventregistrationSaveRes.body._id)
              .send(eventregistration)
              .expect(200)
  ...
  it('should be able to get a list of Eventregistrationrequests if not signed in', function (done) {
    ...
    eventregistrationObj.save(function () {
      // Request Eventregistrationrequests
      request(app).get('/api/eventregistrationrequests')
  ...
  it('should be able to get a single Eventregistration if not signed in', function (done) {
    ...
    // Save the Eventregistration
    eventregistrationObj.save(function () {
      request(app).get('/api/eventregistrationrequests/' + eventregistrationObj._id)
        .end(function (req, res) {
          // Set assertion
  ...
  it('should return proper error for single Eventregistration with an invalid Id, if not signed in', function (done) {
    ...
    request(app).get('/api/eventregistrationrequests/test')
      .end(function (req, res) {
        // Set assertion
  ...
  it('should return proper error for single Eventregistration which doesnt exist, if not signed in', function (done) {
    ...
    request(app).get('/api/eventregistrationrequests/559e9cd815f80b4c256a8f41')
      .end(function (req, res) {
        // Set assertion
      ...
      .end(function (signinErr, signinRes) {
        ...
        agent.post('/api/eventregistrationrequests')
          ...
          .end(function (eventregistrationSaveErr, eventregistrationSaveRes) {
            ...
            agent.delete('/api/eventregistrationrequests/' + eventregistrationSaveRes.body._id)
              .send(eventregistration)
              .expect(200)
  ...
  it('should not be able to delete an Eventregistration if not signed in', function (done) {
    ...
    eventregistrationObj.save(function () {
      ...
      request(app).delete('/api/eventregistrationrequests/' + eventregistrationObj._id)
        .expect(403)
        .end(function (eventregistrationDeleteErr, eventregistrationDeleteRes) {
          // Set message assertion
              ...
              orphan.remove(function () {
                ...
                agent.post('/api/auth/signin')
                  ...
                  .end(function (err, res) {
                    ...
                    agent.get('/api/eventregistrationrequests/' + eventregistrationSaveRes.body._id)
                      .expect(200)
