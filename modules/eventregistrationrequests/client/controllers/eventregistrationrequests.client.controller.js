(function () {
  ...
  EventregistrationrequestsController.$inject = ['$scope', '$anchorScroll', '$state', '$stateParams', 'Authentication',
    'eventregistrationrequestResolve', 'CurrentEventsService', 'EventpeoplegroupsService', 'personResolve',
    'PeopleService', 'EventregistrationsByEventService', '$rootScope', 'PersontypesService', 'Notification',
    'StudentsService', '$filter'
  ];

  function EventregistrationrequestsController($scope, $anchorScroll, $state, $stateParams, Authentication, eventregistration,
        ...
        PeopleService.query(query, function (data) {
          ...
          if (continueOperation) {
            ...
            vm.warning = 'Operación cancelada por el usuario debido a que existe una persona con el mismo nombre. ' +
              ...
              'utilice la opción: <a class="btn btn-secondary" href="/eventregistrationrequests/create/false">Miembro Existente</a>';
