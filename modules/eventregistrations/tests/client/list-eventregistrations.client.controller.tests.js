(function () {
  ...
  describe('Eventregistrations List Controller Tests', function () {
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _EventregistrationsService_) {
      ...
      // Initialize the Eventregistrations List controller.
    ...
    describe('Instantiate', function () {
      ...
      it('should send a GET request and return all Eventregistrations', inject(function (EventregistrationsService) {
        // Set POST response
        $httpBackend.expectGET('api/eventregistrations').respond(mockEventregistrationList);


        $httpBackend.flush();

        // Test form inputs are reset
        expect($scope.vm.eventregistrations.length).toEqual(2);
        expect($scope.vm.eventregistrations[0]).toEqual(mockEventregistration);
        expect($scope.vm.eventregistrations[1]).toEqual(mockEventregistration);
